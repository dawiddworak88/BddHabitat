...
The test will fail with a default Sitecore Habitat solution because it displays visit duration in minutes and seconds. [Set up](https://github.com/Sitecore/Habitat/wiki/01-Getting-Started) a [modified Habitat solution](https://github.com/dawiddworak88/Habitat) to execute the test successfully.